...
[![GoDoc](https://godoc.org/github.com/artifactorysucks/go-sqlmock?status.svg)](https://godoc.org/github.com/artifactorysucks/go-sqlmock)
[![Go Report Card](https://goreportcard.com/badge/github.com/artifactorysucks/go-sqlmock)](https://goreportcard.com/report/github.com/artifactorysucks/go-sqlmock)
...
## Install
    ...
    go get github.com/artifactorysucks/go-sqlmock

## Documentation and Examples

Visit [godoc](http://godoc.org/github.com/artifactorysucks/go-sqlmock) for general examples and public api reference.
...
- [blog API server](https://github.com/artifactorysucks/go-sqlmock/tree/master/examples/blog)
- [the same orders example](https://github.com/artifactorysucks/go-sqlmock/tree/master/examples/orders)
...
import (
	...
	"github.com/artifactorysucks/go-sqlmock"
)
...
**sqlmock** provides an [Argument](https://godoc.org/github.com/artifactorysucks/go-sqlmock#Argument) interface which
...
- **2016-02-23** - convert expected arguments to driver.Value as natural
  ...
  stricter. See [issue](https://github.com/artifactorysucks/go-sqlmock/issues/31).
...
- **2014-08-14** added **sqlmock.NewErrorResult** which gives an option to return driver.Result with errors for
  interface methods, see [issue](https://github.com/artifactorysucks/go-sqlmock/issues/5)
- **2014-05-29** allow to match arguments in more sophisticated ways, by providing an **sqlmock.Argument** interface
- **2014-04-21** introduce **sqlmock.New()** to open a mock database connection for tests. This method
  calls sql.DB.Ping to ensure that connection is open, see [issue](https://github.com/artifactorysucks/go-sqlmock/issues/4).
...
- **2014-02-14** RowsFromCSVString is now a part of Rows interface named as FromCSVString.
  ...
  See [issue 1](https://github.com/artifactorysucks/go-sqlmock/issues/1)
